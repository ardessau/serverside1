...
// set public static files  Use public directory for resources that are static //
// app.use(express.static('public'));
...
// return an indexl.html file when the default route is requested. //
//app.get('/', function (req,res){ // // req,res means request and response. //
    // Any response not coming into to the root of the website will get a 404 not found error. //
    //res.sendfile('index.html'); //  // response.send will send back index.html file //
// }); //
...
// app.listen(3000, function (){  /* app needs to listen on port 3000 */
//    console.log('Example app listening on port 3000.');
// });
